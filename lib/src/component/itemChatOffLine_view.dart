...
import 'package:app_tobe_sonet/src/component/iconAvatarOffline.dart';
...
class Item_ChatOffline extends StatelessWidget {
  @override
  ...
  Widget TitleMess(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          textFieldBold('Rose Tran', 16.sp, colorGrey),
          textFieldRegular(
              'David Pham: I play badminton ...', 13, colorGrey,TextAlign.left),
        ],
      ),
    );
  }
